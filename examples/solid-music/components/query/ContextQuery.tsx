...
export type QueryProps<TData, TVariables extends Record<string, any>> = Omit<PureQueryProps<TData, TVariables>, 'context'>
...
function contextQueryFactory(QueryContext: Context<IQueryContext | undefined>) {
  return function Query<TData, TVariables extends Record<string, any>>(props: QueryProps<TData, TVariables>): JSX.Element {
